        ...
        private static void Main(string[] args)
        {
            try
            {
                ...
                if (args.Length == 0)
                {
                    ...
                    Console.WriteLine($"You have to drag Bendy and the Ink Machine.exe and drop it on top of {installerFileName}.");
                ...
                if (!gameExePath.Contains("Bendy and the Ink Machine.exe"))
                {
                    Console.WriteLine($"You have to drag Bendy and the Ink Machine.exe and drop it on top of {installerFileName}.");
                    Console.WriteLine($"The file dropped was {gameExePath}");
                    Console.WriteLine($"Make sure to follow the instructions provided with the mod.");
                    return;
                }
