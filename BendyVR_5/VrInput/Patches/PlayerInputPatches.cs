...
public class PlayerInputPatches : BendyVRPatch
{
    ...
    private static bool Any(ref bool __result)
    {
        __result = ActionInputDefinitions.Weapon.ButtonDown ||
            ...
            ActionInputDefinitions.ExpoInvert.ButtonDown||
    ...
    [HarmonyPrefix]
    [HarmonyPatch(typeof(PlayerInput), nameof(PlayerInput.ExpoInvert))]
    private static bool PlayerExpoInvert(ref bool __result)
    {
        __result = ActionInputDefinitions.ExpoInvert.ButtonDown;
        return false;
    }
